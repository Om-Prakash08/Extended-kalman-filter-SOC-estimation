...
if __name__ == '__main__':
    ...
    print(my_battery.state_of_charge,"SOC:", SoC,"OCV:", OCV,"RC_voltage:",RC_voltage,"TERMINAL VOLATAGE:",voltage)
    ...
    while my_battery.voltage > cut_off_voltage:
        ...
        print("time=",time[-1],"SOC=", my_battery.state_of_charge,"OCV=", my_battery.OCV,"Terminal Volt=", my_battery.voltage,"RC voltage=",my_battery._RC_voltage)

    print("SOC:", SoC, "OCV:", OCV, "RC_voltage:", RC_voltage, "TERMINAL VOLATAGE:",voltage)
